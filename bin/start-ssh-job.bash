...
SBATCH_PARAM_CPU="-t 4:00:00 -p aisc --account aisc  --mem=32GB --cpus-per-task=12"
SBATCH_PARAM_GPU="-o job.logs -t 4:00:00 -p aisc --account aisc --mem=32GB --cpus-per-task=12 --gpus=h100:1"
